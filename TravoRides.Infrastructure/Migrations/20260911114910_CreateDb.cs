    ...
    public partial class CreateDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LatestThinkings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fuel = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransitId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    Luggage = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bookings_Transit_TransitId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PackageRates_Cabs_CabId",
                        column: x => x.CabId,
                        principalTable: "Cabs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CabId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TransitId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Rate = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Discount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransitRates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TransitRates_Cabs_CabId",
                        column: x => x.CabId,
                        principalTable: "Cabs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransitRates_Transit_TransitId",
                        column: x => x.TransitId,
                        principalTable: "Transit",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageRates_CabId_PackageId",
                table: "PackageRates",
                columns: new[] { "CabId", "PackageId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransitRates_CabId_TransitId",
                table: "TransitRates",
                columns: new[] { "CabId", "TransitId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TransitRates_TransitId",
                table: "TransitRates",
                column: "TransitId");
